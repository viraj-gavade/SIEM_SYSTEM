...
clear
echo "=================================================="
echo "        SIEM System v1.0.0 - Linux/macOS Setup"
echo "=================================================="
echo ""
...
if ! curl -s --head --request GET github.com | head -n 1 | grep "200 OK\|301 Moved\|302 Found" &> /dev/null; then
...
if command -v curl &> /dev/null; then
    curl -o docker-compose.yml https://raw.githubusercontent.com/viraj-gavade/SIEM_SYSTEM/main/docker-compose.yml
elif command -v wget &> /dev/null; then
    wget -O docker-compose.yml https://raw.githubusercontent.com/viraj-gavade/SIEM_SYSTEM/main/docker-compose.yml
else
